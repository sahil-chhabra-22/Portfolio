        ...
        <div className="grid gap-8 sm:grid-cols-2">
          {education.map((edu, index) => (
            ...
            >
              ...
              <motion.div 
                className={index === 0 ? "cursor-pointer inline-block" : "inline-block"}
                onClick={() => index === 0 && setExpandedIndex(expandedIndex === index ? null : index)}
                whileTap={index === 0 ? { scale: 0.95 } : {}}
                transition={{ type: "spring", stiffness: 400, damping: 17 }}
              >
                <motion.h4 
                  whileHover={index === 0 ? { color: '#818cf8' } : {}}
